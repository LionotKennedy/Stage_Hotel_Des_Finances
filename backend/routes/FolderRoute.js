...
const { addFolder, getFolder, editFolderById, updateFolderById, deleteFolderById, CountLettersByMonth, countLetters } = require("../controllers/FolderController");
...
router.delete("/delete_folder/:id", verifyToken, deleteFolderValidator, deleteFolderById); // Nouvelle route pour supprimer un dossier
