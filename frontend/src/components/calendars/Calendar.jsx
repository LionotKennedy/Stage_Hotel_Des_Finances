...
//     const startDate = startOfWeek(firstDayOfMonth, { weekStartsOn: 1 }); // Commencer la semaine le lundi
...
//     let day = startDate;
//     while (day <= endDate) {
//       const isToday = day.toDateString() === date.toDateString() ? "active" : "";
//       daysInMonth.push(
//         <li className={isToday} key={day.toString()}>
//           {format(day, 'd')}
//         </li>
//       );
//       // Utiliser addDays pour avancer d'un jour
//       day = addDays(day, 1);
//     }
...
const Calendar = () => {
  ...
  const renderCalendar = () => {
    ...
    while (day <= endDate) {
      ...
      day.setDate(day.getDate() + 1); // Modification principale ici
    }
